...
class VampireSurvivorsGame(Game):
    ...
    @functools.cached_property
    def characters_emerald_diorama(self) -> List[str]:
        return [
            "Ameya Aisling",
            "Bonnie Blair",
            "Dive No. 5",
    ...
    @functools.cached_property
    def characters_secret_emerald_diorama(self) -> List[str]:
        return [
            "Imakoo",
            "Kina",
    ...
    def characters(self) -> List[str]:
        ...
        if bool(self.archipelago_options.vampire_survivors_allow_secret_characters.value):
            ...
            if self.has_dlc_emerald_diorama:
                characters.extend(self.characters_secret_emerald_diorama)
    ...
    @functools.cached_property
    def base_weapons_emerald_diorama(self) -> List[str]:
        return [
            "Bullova",
            "Eagle Gun",
            "Emerald Rapture",
    ...
    def evolution_weapons_base(self) -> List[str]:
        return [
            ...
            "Carozza! (Carrello + Chaos Lazulia)",
            ...
            "Spirit Disturbance (Unearthly Boly + Tirajisu)",
    ...
    def evolution_weapons_operation_guns(self) -> List[str]:
        return [
            ...
            "Pronto Beam  (C-U-Laser + Weapon Power-Up + Tirajisu)",
    ...
    def evolution_weapons_ode_to_castlevania(self) -> List[str]:
        return [
            ...
            "Meal Ticket  (Wine Glass + Tirajisu)",
    ...
    @functools.cached_property
    def evolution_weapons_emerald_diorama(self) -> List[str]:
        return [
            ...
            "Falconwind (Bullova + Curse O'Maniac)",
            ...
            "Rings of Calamity (Spirit Rings + 5 Passives)",
            "Triangle Kick (Kick + Pummarola)",
    ...
    @functools.cached_property
    def stages_emerald_diorama(self) -> List[str]:
        return [
            "Emerald Diorama",
        ]
